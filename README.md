...
[![Deploying to SQL Server with a DACPAC - Will it Deploy? Episode 4](images/will-it-deploy.png)](https://youtu.be/TODO "Deploying to SQL Server with a DACPAC - Will it Deploy? Episode 4")
